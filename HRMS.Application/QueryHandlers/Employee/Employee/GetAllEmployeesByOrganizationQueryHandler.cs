...
{
    public class GetAllEmployeesByOrgnizationQueryHandler : IRequestHandler<GetAllEmployeeByOrgnizationQuery, List<EmployeeModel>>
    {
        private readonly IEmployeeRepository _repo;

        public GetAllEmployeesByOrgnizationQueryHandler(IEmployeeRepository repo)
        {
            _repo = repo;
        }

        public async Task<List<EmployeeModel>> Handle(GetAllEmployeeByOrgnizationQuery request, CancellationToken cancellationToken)
        {
            var models = await _repo.GetAllEmployeesByOrgAsync(request.Id);
            return models
